...
| `.phyllum/**` | session state, `apply`'s plan at `.phyllum/PRD.md`, `assess`'s numbered reports at `.phyllum/assess-[n].md`, and `assess --json`'s default output; gitignored |
