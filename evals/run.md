...
re-recorded it (v0.5.0 M3, which closed the release). The scores themselves
...
## What is covered today (v0.1.0 M1–M6, v0.2.0 M1–M8, v0.2.1 M1–M6, v0.3.0 M1–M7, v0.4.0 M1–M7, v0.4.1 M1–M3, v0.5.0 M1–M3)
...
| `evals/assertions/evals-baseline.test.js` | Every eval has a rubric, a prompt set and a baseline it has not slipped below; the baseline is the stamped v0.5.0 bar; an unscored eval says so |
