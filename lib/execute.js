 ...
 *
 * Only these three are caught, and deliberately. They are decisions Phyllum
 * itself made — "the backup failed", "that path is not ours to write", "the
 * shipped table is unreadable" — and a decision deserves a sentence, not a
 * stack. Anything else thrown is a bug, and a bug swallowed here is a bug
 * nobody ever fixes.
 */
