...
export const COMMANDS = [
  ...
  },
  {
    ...
    summary: 'Read the codebase and inventory the raw styling in it',
    milestone: 'v0.2.0 M3',
    description: [
      ...
      'Near-identical values are clustered into one decision, counted, and ranked by how often the code leans on them.',
    ...
    modes: [
      'assess — the full assessment: scan, then walk both suggestion tracks',
      'assess tokens — the same scan, fast-forwarded to the token suggestions',
      'assess components — the same scan, fast-forwarded to the component suggestions',
      'assess update — accept the suggestions into DESIGN-SYSTEM.md without the per-item loop',
    ],
    args: [
      '(nothing) — the full assessment',
      '[tokens|components|update] — reserved scope words for the chained modes',
    ],
    example: 'phyllum assess',
  },
  {
    name: 'tokenise',
    aliases: ['tokenize'],
