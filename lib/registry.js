...
export const COMMANDS = [
  ...
  },
  {
    ...
    modes: [
      ...
      'pick — pass nothing and choose from archetypes, candidates found in your codebase, and custom; the latest drift report’s recommendations are shown first when one exists',
