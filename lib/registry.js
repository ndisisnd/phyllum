...
export const COMMANDS = [
  ...
  },
  {
    ...
    description: [
      ...
      'The scan, the table and the proposed names need no model; only the review is a conversation.',
    ...
    modes: [
      ...
      'assess update — the same scan, with the answers supplied: every proposed token accepted under the name in the map, written to DESIGN-SYSTEM.md without the per-item loop',
    ],
    args: [
      ...
      'update — accept the proposed tokens; a value whose role is unknown and a component pick are skipped, never guessed',
  ...
  },
  {
    ...
    summary: 'Plan applying the design system to the codebase — writes a PRD, runs nothing',
    milestone: 'v0.2.0 M6',
    description: [
      ...
      '`apply` writes the plan; `apply run` is what executes it, and that half lands in v0.2.0 M7 — registered and documented until then.',
    ],
    modes: [
      ...
      'apply run — execute the PRD; registered and documented, landing in v0.2.0 M7',
    ],
    args: [
      '(nothing) — create or resume the PRD',
      '--fresh — regenerate from scratch instead of resuming',
      'run — execute the PRD; reserved scope word, landing in v0.2.0 M7',
