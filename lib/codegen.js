 ...
 * to copy; Basal never writes component code into the codebase.
 */
...
export function renderCss(draft, { model = null } = {}) {
  ...
  for (const state of draft.states) {
    ...
    // A state answered in words stays words: Basal will not invent the CSS
...
export function renderJsx(draft) {
  ...
  return [
    '/**',
    ` * ${draft.name} — generated by Basal from DESIGN-SYSTEM.md.`,
    ' *',
    ' * Usage:',
    ' *',
    ' * ```jsx',
